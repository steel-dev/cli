...
This folder contains stable, hand-maintained reference docs for Steel CLI behavior.

Use these docs for migration guidance, compatibility assumptions, and architecture-level workflows.
