...
BASE_URL = os.getenv("STEEL_BASE_URL") or "https://api.steel.dev"
...
client = Steel(steel_api_key=STEEL_API_KEY, base_url=os.getenv("STEEL_BASE_URL") or "https://api.steel.dev")
...
connectUrl = os.getenv("STEEL_CONNECT_URL") or "wss://connect.steel.dev"
cdp_url = f"{connectUrl}?apiKey={STEEL_API_KEY}&sessionId={session.id}"
